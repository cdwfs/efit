    ...
    if ext.lower() == '.m3u8':
        ...
        for song in playlist.tracks:
            if not is_valid_song(song):
                ...
                continue
            song_path = get_song_path(song, music_roots)
            if not song_path:
...
if __name__ == "__main__":
    ...
    lib = load_library_from_file(lib_filename)
    export_playlist(lib, playlist_name, out_filename)
